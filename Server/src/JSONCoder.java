...
public class JSONCoder {
    public static Object decode(String string, int t) // t = 1 - message, t = 2 - contact
    {
        ...
        try {
            ...
            if (((t == Report.CONTACT || t == Report.REGISTATION) || (t == Report.AUTHORISATION || t == Report.DEL_FRIEND)) || t == Report.FIND_CONTACTS) {
    ...
    public static Report decode(String string)
    {
        ...
        try {
            ...
            if(((report.type == Report.CONTACT || report.type == Report.REGISTATION) || (report.type == Report.AUTHORISATION || report.type == Report.DEL_FRIEND)) || report.type == Report.FIND_CONTACTS)
